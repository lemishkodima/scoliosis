...
import { initPageLoader } from "./features/loader.js?v=20260714-transition-no-flicker-1";
...
import { initPageTransitions } from "./features/page-transition.js?v=20260714-transition-no-flicker-1";
